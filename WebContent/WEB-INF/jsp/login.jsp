...
<html>
	...
	<body>
		...
		<form  method="post" action="log_in" class="form center">
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					...
					<div style="color: red;font-size: large;">${sessionScope.info}</div>
					
					<div class="username">
						<div class="left fl">验证码:&nbsp;<input class="yanzhengma" type="text" name="yanzhengma" placeholder="请输入验证码"/></div>
						<!-- 
						<div class="right fl"><img src="<%=request.getContextPath()%>/image/yanzhengma.jpg"></img></div>
						 -->
						<div class="right fl"><img src="./image/yanzhengma.jpg"></img></div>
						<div class="clear"></div>
					</div>
				</div>
